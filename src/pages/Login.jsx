...
<GoogleLogin onSuccess={handleGoogleLogin} onError={() => toast.error("Google login failed")} />
  ...
  return (
    ...
    <div className='text-emerald-700  text-end mb-2 font-display font-stretch-105% font-medium' onClick={()=>navigate('/forgot-password')}>Forgot password?</div>
      <button
      onClick={handleLogin}
    ...
    <div className='text-gray-700  text-center mt-2 font-display font-stretch-105% font-medium'>Don't have a account? <span  onClick={()=>navigate('/register')} className='text-emerald-700 font-stretch-105% font-semibold  '>Register</span></div>
