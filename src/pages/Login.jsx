...
<GoogleLogin onSuccess={handleGoogleLogin} onError={() => toast.error("Google login failed")} />
  ...
  return (
    ...
    <div className='text-emerald-700 text-lg text-end mb-4 font-display font-stretch-105% font-medium' onClick={()=>navigate('/forgot-password')}>Forgot password?</div>
      <button
      onClick={handleLogin}
      className="text-lg w-full flex items-center justify-center px-4 py-4 bg-emerald-700 text-white font-display rounded hover:bg-emerald-800 disabled:opacity-50 font-stretch-105%"
      disabled={loading }
    >
      {loading && (
        <svg
    ...
    <div className='text-gray-700  text-center mt-4 font-display font-stretch-105% font-medium'>Don't have a account? <span  onClick={()=>navigate('/register')} className='text-emerald-700 font-stretch-105% font-semibold text-xl '>Register</span></div>
