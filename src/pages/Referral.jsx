...
const handleCopyLink = () => {
  ...
  return (
    <div className='max-w-2xl font-display font-stretch-105% mx-auto bg-radial-[at_50%_195%] rounded-2xl from-emerald-500 h-60 text-gray-700 to-emerald-800'>
      <div className='p-6 text-3xl font-bold text-white' >Rushtamizha</div>
      <hr className='bg-gray-100 border-none h-0.25 mx-6' />
      <div className='px-6 pt-4 text-2xl text-white font-semibold capitalize'>Hey! {username}</div>
      <div className='px-6  text-white'>You've been choosen for the exclusive referral programme</div>
      <div className='bg-white mx-6 mt-4 p-4 flex gap-4 rounded-xl drop-shadow-xs'>
        <img src="/src/assets/money.png" alt="" className='rounded-full w-18'/>
        <div className='flex flex-col justify-center'>
          <span className='text-xl text-gray-500'>Total Earnings</span>
          <span className='text-3xl font-bold '>₹ {wallet}.00</span>
        </div>
      </div>
      <div className='mx-6 mt-4 bg-white rounded-xl p-4 drop-shadow-xs'>
